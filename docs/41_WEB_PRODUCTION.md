...
As consultas protegidas não são armazenadas pelo Service Worker. A Edge Function de criação utiliza origem configurável por `APP_ORIGIN`, com produção como fallback; previews devem configurar sua origem explicitamente no ambiente Edge.
