...
set daily_quote_limit = 5, is_unlimited = false, is_public = true,
    is_default_free = true, sort_order = 0
where code = 'free';

update public.saas_plans
set is_unlimited = true, is_public = true,
    is_default_free = false, sort_order = 10
where code = 'premium';
