...
export type Database = {
  public: {
    ...
    Functions: { verify_employee_pin: { Args: { target_employee_id: string; submitted_pin: string }; Returns: boolean }; get_employee_pin_status: { Args: { target_employee_id: string }; Returns: boolean }; set_initial_employee_pin: { Args: { target_employee_id: string; submitted_pin: string }; Returns: boolean }; set_my_business_availability: { Args: { p_is_available: boolean }; Returns: boolean }; mark_notification_read: { Args: { target_id: string }; Returns: Database["public"]["Tables"]["notification_center"]["Row"] }; mark_all_notifications_read: { Args: Record<never, never>; Returns: number }; delete_notification: { Args: { target_id: string }; Returns: boolean } };
