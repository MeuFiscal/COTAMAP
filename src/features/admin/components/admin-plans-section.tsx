...
function PlanEditor({ plan, onClose, update }: { plan?: Plan; onClose: () => void; update: Props["update"] }) {
  ...
  const submit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const body: Record<string, unknown> = {
      ...
      provider: String(f.get("provider") ?? "") || null, provider_product_id: String(f.get("provider_product_id") ?? "") || null,
      provider_offer_id: String(f.get("provider_offer_id") ?? "") || null, provider_checkout_id: String(f.get("provider_checkout_id") ?? "") || null,
