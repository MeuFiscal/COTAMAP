...
export function PrivateShell({ children, businessRole }: { children: ReactNode; businessRole?: string | null }) {
  ...
  const isBusiness = pathname.startsWith("/empresa") || Boolean(businessRole);
